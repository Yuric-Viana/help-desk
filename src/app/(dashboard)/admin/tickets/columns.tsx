...
export const columns: ColumnDef<TicketRow>[] = [
  ...
  {
    accessorKey: "title",
    header: () => <p className="text-app-gray-400 text-sm">Título e serviço</p>,
    cell: ({ row }) => {
  ...
  },
  {
    accessorKey: "client",
    header: () => (
      <p className="text-app-gray-400 hidden text-sm md:table-cell">Cliente</p>
    ),
    meta: { className: "hidden md:table-cell" },
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: () => (
      <p className="text-app-gray-400 hidden text-sm md:table-cell">Técnicos</p>
    ),
    meta: { className: "hidden md:table-cell" },
    cell: ({ row }) => {
